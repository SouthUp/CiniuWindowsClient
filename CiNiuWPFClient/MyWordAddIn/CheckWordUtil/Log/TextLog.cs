...
namespace CheckWordUtil.Log
{
    ...
    public static class TextLog
    {
        ...
        private static string errorLogDir = Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) + "\\CiNiuAddIn\\ClientErrorLog\\";
        /// <summary>
        ///  错误日志默认位置
        /// </summary>
        ...
        private static string normalLogDir = Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) + "\\CiNiuAddIn\\ClientNormalLog\\";
